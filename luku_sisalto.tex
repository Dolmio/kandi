...
Hakujen tuloksista luettiin abstraktit läpi ja harkintaa käyttäen seulottiin artikkeleita tarkempaa tutustumista varten. Seulonnassa erityistä huomiota saivat artikkelit, jotka esittelivät tai tutkivat algoritmeja fiksaatioden tunnistamiseksi. Työssä käytetty lähdekirjallisuus on kokonaisuudessaan englanninkielistä ja koostuu pääosin tieteellisistä artikkeleista sekä konferenssijulkaisuista.


\subsection{Erilaisia silmänliikkeitä}
...
\[
FQnS = 100 * {{tunnistettujen\ fiksaatioiden\ lkm} \over {referenssifiksaatioiden lkm}}
\]
...
Algoritmien vertailemiseen käytetään Aalto-Yliopistossa Mediatekniikan laitoksella 2013 tehdyn tutkimuksen katseentunnistusosion raakadatoja. Tutkimuksessa koehenkilöille näytettiin kuvia yhdeksästä uutisesta kymmenen kuvaa per uutinen. Jokaista kuvaa näytettiin viisi sekuntia ja jokaisen kuvan katsomisesta kerättiin silmänliikedataa. Datan keräämiseen käytettiin SMI RED 250-katseentunnistuslaitetta, joka oli asetettuna koehenkilön päähän. Näytteenottotaajuus käytetyllä katseentunnistuslaitteella on 250Hz eli uusi datapiste saadaan n. 4ms välein. Markkinoilta löytyy myös katseentunnistuslaitteita kuten SMI HiSpeed, joilla näytteenottotaajuus on niinkin korkea kuin 1250Hz.\citep[s.197]{nystrom2010} Kun tarkoituksena on selvittää mihin ihmisen huomio kiinnittyy kuvia katsellessa, eikä esim. mikrosakkadien mekaniikkaa, voidaan 250Hz näytteenottotaajuutta pitää kuitenkin jo aivan riittävänä tarkkuutena.
...
\begin{minipage}{.45\textwidth}
  ...
  \captionof{figure}{Uutiskuva 54. Helsinki-päivästä}
  \label{fig:news-pic}
\end{minipage}%
\hspace{.5cm}
\begin{minipage}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{raw-data.jpg}
  \captionof{figure}{Raakadata koehenkilöltä}
  \label{fig:raw-data}
\end{minipage}
\end{figure}
...
\begin{minipage}{.6\textwidth}
  ...
  \captionof{figure}{Katseeentunnistuslaitteen löytämät fiksaatiot yhdeltä koehenkilöltä}
...
\subsubsection{I-VT nopeusraja-arvoalgoritmi}
...
\begin{minipage}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{guitar.jpg}
  \captionof{figure}{Fiksaatiot raja-arvolla 10 VAIHDA KUVA}
\end{minipage}%
\hspace{.5cm}
\begin{minipage}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{sample-fixations.jpg}
  \captionof{figure}{Fiksaatiot raja-arvolla 20 VAIHDA KUVA}
\end{minipage}
\end{figure}
...
\begin{minipage}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{guitar.jpg}
  \captionof{figure}{Fiksaatiot raja-arvolla 34 VAIHDA KUVA}
	  \label{fig:vel-fixations-literature-threshold}
\end{minipage}%
\hspace{.5cm}
\begin{minipage}{.45\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{sample-fixations.jpg}
  \captionof{figure}{Fiksaatiot raja-arvolla 60 VAIHDA KUVA}
\end{minipage}
\end{figure}

 
\subsubsection{I-DT dispersioraja-arvoalgoritmi}
Dispersioraja-arvoalgoritmille käytettiin syötteenä samaa kuvan \ref{fig:raw-data} dataa kuin nopeusraja-arvoalgoritmille. Dispersioraja-arvoalgoritmi käyttää kahta parametria: dispersioraja-arvoa sekä fiksaation minimipituutta.
