...
Tätä työtä varten uutiskuvista valittiin yksi kuva, jonka katsomisesta kerättyjä datoja käytetään tunnistusalgoritmien vertailuun. Kuvaksi valittiin kuvajoukosta sellainen kuva, josta löytyy selkeitä kiinnekohtia, joihin katseella olisi mahdollista hakeutua. 
...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{Katseentunnistuslaitteen löytämät fiksaatiot}
